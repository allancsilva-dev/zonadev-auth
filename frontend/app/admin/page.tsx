          ...
          {recent.map(tenant => (
            <div key={tenant.id} className="flex items-center justify-between">
              <div>
                ...
                <p className="text-slate-500 text-xs font-mono">{tenant.subdomain}.zonadev.tech</p>
              </div>
...
export default function DashboardPage() {
  return (
    <div className="space-y-8">
      ...
      {/* Stats via TanStack Query — client-side com loading/error state */}
      <StatsCards />

      {/* Listas recentes — Server Components com Suspense independente */}
